...
End-to-end fraud detection pipeline on 284,807 real transactions. Built for American Express data analyst interview portfolio.

Problem
Only 0.17% of transactions are fraudulent — severe class imbalance makes accuracy a useless metric. Optimised for Recall and AUC-ROC.
...
Plots
Class Imbalance ROC Curves Threshold Tuner
